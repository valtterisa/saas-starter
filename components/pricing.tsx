...
export default function Pricing({ user, products, subscription }: Props) {
  ...
  return (
    <section id="pricing" className="bg-black py-16 md:py-24 w-full">
      <div className="max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 md:text-xl max-w-[700px] mx-auto text-zinc-300">
          ...
          {products.map((product) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "flex flex-col rounded-xl border bg-background p-6 shadow-sm transition-all hover:shadow-md",
                  {
